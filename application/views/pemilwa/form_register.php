...
<div class="formBox">
    <form id="form" class="tengahin" action="<?php echo base_url() . "CrisisKRS2020/submit"; ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Email UB (wajib diisi)" name="email_ub" required>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('form').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url("pemilwa/process_register") ?>',
                ...
                if (!data.success) {
                    ...
                    console.log(data)
                    console.log('selesai di done fucntion')
                    $("#form").trigger("reset");
                }
            })
